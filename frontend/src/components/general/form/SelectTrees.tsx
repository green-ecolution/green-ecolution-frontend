...
const SelectTrees: React.FC<SelectTrees> = ({ treeIds, onClick, storeState }) => {
  ...
  return (
    <div>
      ...
      <button onClick={() => handleStoreState()} className="mt-6 w-fit border border-green-light text-dark-800 px-5 py-2 group flex gap-x-3 rounded-xl items-center transition-all ease-in-out duration-300 hover:border-green-dark hover:text-dark">
