...
import { Route as ProtectedSettingsPluginImport } from './routes/_protected/settings/plugin'
...
const ProtectedSettingsPluginRoute = ProtectedSettingsPluginImport.update({
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_protected/settings/plugin': {
      ...
      preLoaderRoute: typeof ProtectedSettingsPluginImport
      parentRoute: typeof ProtectedImport
    }
    '/_protected/tree/new': {
...
/* ROUTE_MANIFEST_START
{
  "routes": {
    ...
    "/_protected/settings/plugin": {
      "filePath": "_protected/settings/plugin.tsx",
      "parent": "/_protected"
    },
    "/_protected/tree/new": {
